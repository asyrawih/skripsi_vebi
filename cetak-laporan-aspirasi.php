...
if ($_POST['file'] == "pdf") {
  ...
  $html = '<!DOCTYPE html>
      ...
      <body>
          ...
          <h4>' . tgl_indo($_POST['awal']) . ' - ' . tgl_indo($_POST['akhir']) . '</h4>
          <hr>
